...
if (isset($_POST['report'])) {
    ...
    $sql = "INSERT INTO `fir` (`firname`, `firfathername`, `firmothername`, `aadhar`, `phno`, `email`, `datetime`, `placeocc`,  `address`, `crimedesc`) VALUES ('$name', '$fathername', '$mothername', '$aadhar', '$phno', '$email', '$dt', '$place', '$addr', '$desc')";
