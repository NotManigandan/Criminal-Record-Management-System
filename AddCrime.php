...
<div class="form">
    <form method="POST" action="AddCrime.php">
        <div class="contain">
            ...
            <input type="text" placeholder="Enter Date of Crime" name="CrimeDate" id="Date" required>
            <br>

            <a class=" button-1 btn btn-success btn-lg" href="Crime.php" role="button">Go Back</a>
            &nbsp;
            &nbsp;
            &nbsp;
            &nbsp;
            ...
            &nbsp;
            &nbsp;
            <button style="margin-left: 15em;" class=" button-1 btn btn-success btn-lg" value="Save" name="bclkcrime">Save</button>
        </div>
    </form>
</div>
